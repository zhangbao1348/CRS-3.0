...
/**
 * BookingControlLog 实体类
 * 
 * <p>本核心模块自动生成详细注释。主要负责【BookingControlLog】相关的核心业务数据承载与持久化映射。</p>
 * 
 * <p>关键元数据关联：</p>
 * <ul>
 *     <li>**关联PRD文档**：.kiro/specs/prd/11-库存管理.md</li>
 *     <li>**模块职责**：单一职责原则，提供 BookingControlLog 数据结构的定义或相关的 CRUD 数据库交互操作。</li>
 * </ul>
 * 
 * @since 2026-05-10
 */
...
@Entity
@Table(name = "booking_control_logs")
public class BookingControlLog {
    @Id
