...
public class PermissionDataInitController {
    ...
    private void initArchives() {
        ...
        arch1.setName("档案1");
        arch1.setType("公司");
        arch1.setContactName("张三");
        arch1.setContactPhone("13800138000");
        arch1.setAddress("北京市");
        arch1.setStatus("启用");
        arch1.setBookingCode("BOOK001");
        arch1.setRateCodes("[{\"hotel\":\"JJSH001\",\"rateCode\":[\"CORP01\"]}]");
        arch1.setGroupId(1);
        ...
        arch2.setName("档案2");
        arch2.setType("旅行社");
        arch2.setContactName("李四");
        arch2.setContactPhone("13900139000");
        arch2.setAddress("上海市");
        arch2.setStatus("启用");
        arch2.setBookingCode("BOOK002");
        arch2.setRateCodes("[{\"hotel\":\"JJSH001\",\"rateCode\":[\"CORP02\"]}]");
        arch2.setGroupId(1);
        archiveRepository.save(arch2);
