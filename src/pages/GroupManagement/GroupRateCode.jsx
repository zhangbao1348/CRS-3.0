    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="middle">
          ...
          <Button type="link" size="small" icon={<EditOutlined />} onClick={() => navigate('/group-management/add-rate-code', { state: { record } })}>编辑</Button>
      ...
      <Card style={{ marginBottom: 24 }}>
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12} md={8} lg={6}>
            <Input placeholder="房价码名称" prefix={<SearchOutlined />} allowClear />
          </Col>
          <Col xs={24} sm={12} md={8} lg={6}>
            <Input placeholder="房价码代码" allowClear />
          </Col>
          <Col xs={24} sm={12} md={8} lg={6}>
            <Select placeholder="房价类别" allowClear style={{ width: '100%' }}>
          ...
          <Col xs={24} sm={12} md={8} lg={6}>
            <Select placeholder="市场码" allowClear style={{ width: '100%' }}>
          ...
          <Col xs={24} sm={12} md={8} lg={6}>
            <Select placeholder="来源码" allowClear style={{ width: '100%' }}>
          ...
          <Col xs={24} sm={12} md={8} lg={6}>
            <Select placeholder="促销优惠" allowClear style={{ width: '100%' }}>
