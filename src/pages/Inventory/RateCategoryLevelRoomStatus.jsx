...
const RateCategoryLevelRoomStatus = () => {
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', marginBottom: 16, gap: 16 }}>
        <Select value={selectedRateCategory} style={{ width: 180 }} size="middle" onChange={setSelectedRateCategory}>
...
export default RateCategoryLevelRoomStatus
